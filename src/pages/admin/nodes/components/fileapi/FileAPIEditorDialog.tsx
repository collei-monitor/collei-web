...
interface FileAPIEditorDialogProps {
  open: boolean;
  mode: "create" | "edit";
  fileName: string;
  filePath?: string;
...
export function FileAPIEditorDialog({
  open,
  mode,
  fileName,
  filePath,
        ...
        <div className="space-y-3">
          {mode === "create" && (
            <div className="space-y-2">
              <Label htmlFor="editor-file-name">{t("fileapi.editor.fileName")}</Label>
              <Input
                id="editor-file-name"
                value={fileName}
                onChange={(e) => onFileNameChange(e.target.value)}
                placeholder={t("fileapi.editor.fileNamePlaceholder")}
              />
            </div>
          )}
          ...
          {loading ? (
            ...
            <>
              <div className="flex items-center gap-2">
                <Label className="shrink-0 text-xs text-muted-foreground">{t("fileapi.editor.encoding")}</Label>
